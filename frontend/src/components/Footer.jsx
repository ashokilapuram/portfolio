      ...
      <div className="footer-content">
        ...
        <div className="footer-right">
          <div className="footer-links">
            <a href="#" className="footer-link" title="Instagram" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
            ...
            <a href="#" className="footer-link" title="Gmail" aria-label="Gmail" target="_blank" rel="noopener noreferrer">
            ...
            <a href="#" className="footer-link" title="LinkedIn" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
